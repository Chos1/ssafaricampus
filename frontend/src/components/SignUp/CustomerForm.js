    ...
    <div>
      <form onSubmit={signUpHandler}>
        <div className="inputgroup">
          ...
          <br />
          <label>학교 이메일</label>
          <input className="info_add" type="email" value={email} onChange={emailChangeHandler} placeholder="학교 이메일을 입력해주세요" />
          <SWBtnPBrd className="info_confirm">이메일 인증</SWBtnPBrd>
          {isValidEmail}
          <br />
          <label>전화번호</label>
          <input value={phone} type="text" onChange={phoneChangeHandler} maxLength="11" placeholder="숫자만 입력해주세요" />
